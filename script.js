...
var map = new mapboxgl.Map({
    ...
    zoom: 2.2*Math.log10(window.innerWidth/50),
...
// when a feature's hover usa is set to true.
    ...
    map.on('idle', 'usa-fills', function (e) {
        ...
        sidebarSummary.innerHTML = "<div class='mti_tooltip_text_cont'>" + 
                ...
                usa_prop.NAME + " Data <i class='fa fa-long-arrow-right'></i></div></a>";
    });
...
// location of the feature, with description HTML from its properties.
    ...
    map.on('click', 'usa-fills', function(e) {
        ...
        // https://data.newamericaneconomy.org/en/map-the-impact-states-jan2020/
    });
...
function forwardGeocoder(query) {
    ...
    for (var i = 0; i < countyList.features.length; i++) {
        ...
        if (
            ...
            bbox_search = turf.extent(featureMSA);
            map.fitBounds(bbox_search, {
                padding: 200
            });
...
var geocoder = new MapboxGeocoder({ // Initialize the geocoder
    ...
    placeholder: 'Enter an address, city, county, state, or place...',
        ...
        // location of the feature, with description HTML from its properties.
            ...
            map.on('click', 'state-fills', function(e) {
                ...
                sidebarSummary.innerHTML = "<div class='mti_tooltip_text_cont'>" + 
                        ...
                        "<div class='see_more_button'>More " + 
                        state_prop.NAME + " Data <i class='fa fa-long-arrow-right'></i></div></a>";
        ...
        // location of the feature, with description HTML from its properties.
            ...
            map.on('click', 'district-fills', function(e) {
                ...
                if (district_prop["District No."].includes("(at Large)") == true) {
                    ...
                    "<div class='see_more_button'>More " + 
                    district_prop["District No."] + " Data <i class='fa fa-long-arrow-right'></i></div></a>";
                } else {
        ...
        // location of the feature, with description HTML from its properties.
            ...
            map.on('click', 'msa-fills', function(e) {
                ...
                sidebarSummary.innerHTML = "<div class='mti_tooltip_text_cont'>" + 
                    ...
                    "<div class='see_more_button'>More " + 
                    msa_prop.NAME + " Data <i class='fa fa-long-arrow-right'></i></div></a>";
